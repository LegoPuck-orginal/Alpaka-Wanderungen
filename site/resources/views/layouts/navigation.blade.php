<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('reviews.create')" :active="request()->routeIs('reviews.*')">
                        {{ __('Bewertung') }}
                    </x-nav-link>
                    @can('access-admin')
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('reviews.create')" :active="request()->routeIs('reviews.*')">
                {{ __('Bewertung') }}
            </x-responsive-nav-link>
            @can('access-admin')
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            @else
                <div class="px-4 py-4 space-y-2">
                    ...
                    <a href="{{ route('register') }}" class="block text-sm text-gray-600 hover:text-gray-900">
                        {{ __('Registrieren') }}
                    </a>
                </div>
            @endauth
